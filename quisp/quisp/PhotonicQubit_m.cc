...
PhotonicQubit_Base::PhotonicQubit_Base(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    ...
    this->QNICtypeEntangledWith = -1;
    this->error_random_for_debug = 0;
    this->first = false;
    this->last = false;
}

PhotonicQubit_Base::PhotonicQubit_Base(const PhotonicQubit_Base& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}

PhotonicQubit_Base::~PhotonicQubit_Base()
{
}

PhotonicQubit_Base& PhotonicQubit_Base::operator=(const PhotonicQubit_Base& other)
{
...
void PhotonicQubit_Base::copy(const PhotonicQubit_Base& other)
{
    ...
    this->QNICtypeEntangledWith = other.QNICtypeEntangledWith;
    this->error_random_for_debug = other.error_random_for_debug;
    this->first = other.first;
    this->last = other.last;
}

void PhotonicQubit_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->QNICtypeEntangledWith);
    doParsimPacking(b,this->error_random_for_debug);
    doParsimPacking(b,this->first);
    doParsimPacking(b,this->last);
}

void PhotonicQubit_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->QNICtypeEntangledWith);
    doParsimUnpacking(b,this->error_random_for_debug);
    doParsimUnpacking(b,this->first);
    doParsimUnpacking(b,this->last);
}

const char * PhotonicQubit_Base::getMessage_type() const
{
    return this->message_type.c_str();
}

void PhotonicQubit_Base::setMessage_type(const char * message_type)
{
    this->message_type = message_type;
}

bool PhotonicQubit_Base::getPauliXerr() const
{
    return this->pauliXerr;
}

void PhotonicQubit_Base::setPauliXerr(bool pauliXerr)
{
    this->pauliXerr = pauliXerr;
}

bool PhotonicQubit_Base::getPauliZerr() const
{
    return this->pauliZerr;
}

void PhotonicQubit_Base::setPauliZerr(bool pauliZerr)
{
    this->pauliZerr = pauliZerr;
}

bool PhotonicQubit_Base::getPhotonLost() const
{
    return this->photonLost;
}

void PhotonicQubit_Base::setPhotonLost(bool photonLost)
{
    this->photonLost = photonLost;
}

bool PhotonicQubit_Base::getNonPaulierr() const
{
    return this->nonPaulierr;
}

void PhotonicQubit_Base::setNonPaulierr(bool nonPaulierr)
{
    this->nonPaulierr = nonPaulierr;
}

bool PhotonicQubit_Base::getNonPaulierrTwo() const
{
    return this->nonPaulierrTwo;
}

void PhotonicQubit_Base::setNonPaulierrTwo(bool nonPaulierrTwo)
{
    this->nonPaulierrTwo = nonPaulierrTwo;
}

int PhotonicQubit_Base::getNodeEntangledWith() const
{
    return this->NodeEntangledWith;
}

void PhotonicQubit_Base::setNodeEntangledWith(int NodeEntangledWith)
{
    this->NodeEntangledWith = NodeEntangledWith;
}

int PhotonicQubit_Base::getQNICEntangledWith() const
{
    return this->QNICEntangledWith;
}

void PhotonicQubit_Base::setQNICEntangledWith(int QNICEntangledWith)
{
    this->QNICEntangledWith = QNICEntangledWith;
}

int PhotonicQubit_Base::getStationaryQubitEntangledWith() const
{
    return this->StationaryQubitEntangledWith;
}

void PhotonicQubit_Base::setStationaryQubitEntangledWith(int StationaryQubitEntangledWith)
{
    this->StationaryQubitEntangledWith = StationaryQubitEntangledWith;
}

GOD_statQubitPtr& PhotonicQubit_Base::getEntangled_with()
{
    return this->entangled_with;
}

void PhotonicQubit_Base::setEntangled_with(const GOD_statQubitPtr& entangled_with)
{
    this->entangled_with = entangled_with;
}

int PhotonicQubit_Base::getQNICtypeEntangledWith() const
{
    return this->QNICtypeEntangledWith;
}

void PhotonicQubit_Base::setQNICtypeEntangledWith(int QNICtypeEntangledWith)
{
    this->QNICtypeEntangledWith = QNICtypeEntangledWith;
}

double PhotonicQubit_Base::getError_random_for_debug() const
{
    return this->error_random_for_debug;
}

void PhotonicQubit_Base::setError_random_for_debug(double error_random_for_debug)
{
    this->error_random_for_debug = error_random_for_debug;
}

bool PhotonicQubit_Base::getFirst() const
{
    return this->first;
}

void PhotonicQubit_Base::setFirst(bool first)
{
    this->first = first;
}

bool PhotonicQubit_Base::getLast() const
{
    return this->last;
}

void PhotonicQubit_Base::setLast(bool last)
{
    this->last = last;
}
...
PhotonicQubitDescriptor::PhotonicQubitDescriptor() : omnetpp::cClassDescriptor("quisp::messages::PhotonicQubit", "omnetpp::cMessage")
{
...
{
    return dynamic_cast<PhotonicQubit_Base *>(obj)!=nullptr;
}
...
int PhotonicQubitDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "entangled_with")==0) return base+9;
    if (fieldName[0]=='Q' && strcmp(fieldName, "QNICtypeEntangledWith")==0) return base+10;
    if (fieldName[0]=='e' && strcmp(fieldName, "error_random_for_debug")==0) return base+11;
    if (fieldName[0]=='f' && strcmp(fieldName, "first")==0) return base+12;
    if (fieldName[0]=='l' && strcmp(fieldName, "last")==0) return base+13;
...
int PhotonicQubitDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    PhotonicQubit_Base *pp = (PhotonicQubit_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
std::string PhotonicQubitDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: {std::stringstream out; out << pp->getEntangled_with(); return out.str();}
        case 10: return long2string(pp->getQNICtypeEntangledWith());
        case 11: return double2string(pp->getError_random_for_debug());
        case 12: return bool2string(pp->getFirst());
        case 13: return bool2string(pp->getLast());
        default: return "";
    }
}
...
bool PhotonicQubitDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 10: pp->setQNICtypeEntangledWith(string2long(value)); return true;
        case 11: pp->setError_random_for_debug(string2double(value)); return true;
        case 12: pp->setFirst(string2bool(value)); return true;
        case 13: pp->setLast(string2bool(value)); return true;
...
const char *PhotonicQubitDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 9: return omnetpp::opp_typename(typeid(GOD_statQubitPtr));
        default: return nullptr;
    };
}
...
void *PhotonicQubitDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    PhotonicQubit_Base *pp = (PhotonicQubit_Base *)object; (void)pp;
    switch (field) {
        case 9: return (void *)(&pp->getEntangled_with()); break;
        default: return nullptr;
    }
}
